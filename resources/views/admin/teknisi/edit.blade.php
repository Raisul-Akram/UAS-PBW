...
@section('header_title', 'Edit Teknisi ' . $teknisi->nama)
...
<div class="max-w-xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-extrabold text-slate-950">Edit Data Teknisi</h2>
            <p class="text-sm text-slate-500">Perbarui data spesialisasi keahlian, nomor HP, atau status aktif teknisi.</p>
        </div>
    </div>

    <div class="bg-white p-6 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
        <form method="POST" action="{{ route('admin.teknisi.update', $teknisi->id) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" id="nama" name="nama" value="{{ old('nama', $teknisi->nama) }}" placeholder="Contoh: Ahmad Hidayat"
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" id="no_hp" name="no_hp" value="{{ old('no_hp', $teknisi->no_hp) }}" placeholder="Contoh: 081234567890"
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" id="spesialisasi" name="spesialisasi" value="{{ old('spesialisasi', $teknisi->spesialisasi) }}" placeholder="Contoh: Hardware Laptop / Layar / HP Android"
            ...
            <div class="flex items-center gap-3">
                ...
                <input type="checkbox" id="status_aktif" name="status_aktif" value="1" {{ old('status_aktif', $teknisi->status_aktif) ? 'checked' : '' }}
                       class="w-4.5 h-4.5 text-amber-500 bg-slate-100 border-slate-300 rounded focus:ring-amber-500/20">
                <label for="status_aktif" class="text-sm font-semibold text-slate-700 select-none">Teknisi aktif dan siap menerima tugas perbaikan</label>
            </div>
            ...
            <div class="pt-4 flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-3 bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold rounded-xl transition-all shadow-lg shadow-amber-500/10">Perbarui Teknisi</button>
            </div>
        </form>
    </div>
</div>
